...
plot "accuracy.txt" using 1:($2*100) w lp lt 1 lw 2 pt 5 ps 2 title ""
set output
...
set output "prediction_conficence_vs_id.eps"
set ylabel "Prediction Confidence (%)"
# plot "skip_accuracy.txt" using 2 ti col
plot "skip_accuracy.txt" using 1:($2*100) w lp lt 1 lw 2 pt 5 ps 2 title ""
set output
